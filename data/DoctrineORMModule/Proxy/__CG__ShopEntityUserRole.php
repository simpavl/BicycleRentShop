 ...
 */
class UserRole extends \Shop\Entity\UserRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Shop\\Entity\\UserRole' . "\0" . 'id', '' . "\0" . 'Shop\\Entity\\UserRole' . "\0" . 'roleId', '' . "\0" . 'Shop\\Entity\\UserRole' . "\0" . 'parent'];
        }
